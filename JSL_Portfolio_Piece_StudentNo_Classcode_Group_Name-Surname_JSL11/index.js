...
function init() {
  // Check if 'sideLogoDiv' is set in localStorage and matches the light logo path
  if (localStorage.getItem('sideLogoDiv') === './assets/logo-light.svg') {
    // If it does, set the 'src' attribute of 'elements.sideLogoDiv' to the light logo path
  ...
  // Check if the 'showSideBar' value in localStorage is set to 'true'
  const showSidebar = localStorage.getItem('showSideBar') === 'true';
  // Call 'toggleSidebar' function with the value from localStorage
  toggleSidebar(showSidebar);

  // Check if the 'light-theme' value in localStorage is set to 'enabled'
  const isLightTheme = localStorage.getItem('light-theme') === 'enabled';
  // Set the 'checked' property of 'elements.themeSwitch' to the value of 'isLightTheme'
  elements.themeSwitch.checked = isLightTheme;
  // Toggle the 'light-theme' class on the document body based on 'isLightTheme'
  document.body.classList.toggle('light-theme', isLightTheme);

  // Fetch and display boards and tasks on initialization
